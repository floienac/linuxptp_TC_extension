...
/*Transparent clock extension -->*/
	{ "TRANSPARENT", TLV_TRANSPARENT, do_get_action },
/*<--Transparent clock extension*/
...
/*Transparent clock extension -->*/
	case TLV_TRANSPARENT:
		...
		fprintf(fp, "TRANSPARENT "
			IFMT "transparentCLock %d", mtd->val & DDS_TRANSPARENT ? 1 : 0);
		break;
/*<--Transparent clock extension*/
...
/*Transparent clock extension -->*/
		/* also include PS_TRANSPARENT in possible values */
		if (p->portState > PS_TRANSPARENT) {
/*<--Transparent clock extension*/
			p->portState = 0;
		}
