...
/*Transparent clock extension -->*/
/**
 * Obtains a reference to the port according to its side in TC.
 * @param side  The side in TC: SIDE_MASTER or SIDE_SLAVE.
 * @param c  	The clock instance.
...
/*Transparent clock extension -->*/	
/**
 * Set a transparent clock residence time.
 * @param c     A pointer to a clock instance obtained with clock_create().
 * @param delay The value of the residence time in ms.
 */
...
/*Transparent clock extension -->*/	
/**
 * Obtain the transparent clock last residence time.
 * @param c     A pointer to a clock instance obtained with clock_create().
 * @return  	The transparent clock residence time in ms.
 */
...
/*Transparent clock extension -->*/
/**
 * Obtain the transparent flag from a clock's default data set.
 * @param c  The clock instance.
 * @return   The value of the clock's transparent flag.
 */
