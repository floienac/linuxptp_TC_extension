...
/*Transparent clock extension -->*/
	/* deal with other cases (e.g. PS_TRANSPARENT) but might be unsafe */
	default:
		break;
/*<--Transparent clock extension*/
	}
...
/*Transparent clock extension -->*/
/* this was copied from "ptp_fsm" and adapted for a TC but some cases
 * can be summarized or rewritten in a more elegant way */
enum port_state ptp_tc_fsm(enum port_state state, enum fsm_event event, int mdiff)
{
	enum port_state next = state;
