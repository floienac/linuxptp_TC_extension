...
/**
 * Copy the common header of an existing message instance.
 * @param m_dest  	Existing message to copy in.
 * @param m_src		Existing message to copy the header from.
 */
...
/*Transparent clock extension -->*/
/**
 * Copy all the fields of an existing message instance.
 * @param m_src		Existing message to copy the fields from.
 * @param m_dest	Existing message to copy in.
 *
 * @return   Zero on success, non-zero if the copy failed.
 */
